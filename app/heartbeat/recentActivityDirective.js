...
angular.module('myVillages.tasker.app.heartbeat.directives')
    .directive('recentActivity', ['$http', '$sce', 'API_BASE_URL', 'heartBeatInterval', '$rootScope', function ($http, $sce, API_BASE_URL, heartBeatInterval, $rootScope) {
    	return {
            ...
            , templateUrl: '/Scripts/tasker/app/heartbeat/recentActivity.html'
            , link: function (scope, elem, attrs) {
            	...
            	function fetch(args) {
            	    if (args['HeartBeatInterval']) {
            	        ...
            	        $http.get(API_BASE_URL + 'heartbeat/activity', { params: args, ignoreLoadingBar: true })
                            .then(function (result) {
                                scope.vm.feed = result.data
