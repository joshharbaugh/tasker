...
angular.module('myVillages.tasker.app.heartbeat.directives')
    .directive('recentMessages', ['$http', 'API_BASE_URL', 'heartBeatInterval', '$sce', '$rootScope', function ($http, API_BASE_URL, heartBeatInterval, $sce, $rootScope) {
        return {
            restrict: 'A'
            ...
            , templateUrl: '/Scripts/tasker/app/heartbeat/recentMessages.html'
            , link: function (scope, elem, attrs) {
                ...
                function fetch(args) {
                    if (args['HeartBeatInterval']) {
                        ...
                        $http.get(API_BASE_URL + 'heartbeat/messages', { params: args, ignoreLoadingBar: true })
                            .then(function (result) {
                                scope.vm.messages = result.data
