...
angular.module('myVillages.tasker.app.heartbeat.directives')
    .directive('estimatesRequested', ['$http', 'API_BASE_URL', '$sce', 'heartBeatInterval', '$rootScope', function ($http, API_BASE_URL, $sce, heartBeatInterval, $rootScope) {
        return {
            restrict: 'A'
            ...
            , templateUrl: '/Scripts/tasker/app/heartbeat/estimatesRequested.html'
            , link: function (scope, elem, attrs) {
                ...
                function fetch(args) {
                    if (args['HeartBeatInterval']) {
                        ...
                        $http.get(API_BASE_URL + 'heartbeat/estimates', { params: args, ignoreLoadingBar: true })
                        .then(function (result) {
                            scope.vm.estimates = result.data
