angular.module('myVillages.tasker.app.userTaskGrid').
    controller('ParentGridController', ['$scope', '$http', '$interval', '$httpBackend', 'uiGridTreeViewConstants', 'uiGridGroupingConstants',
    'authService', '$q', '$routeParams', 'userTaskGridDataService', 'uiGridConstants', 'parentGridService','$modal',
    function ($scope, $http, $interval, $httpBackend, uiGridTreeViewConstants, uiGridGroupingConstants, authService, $q, $routeParams, userTaskGridDataService, uiGridConstants, parentGridService, $modal) {
        var that = this;
        ...
        var loadUserTasksGrid = function () {
            parentGridService.getSortedTasksAndGroups($scope).then(function (sortedTasksAndGroups) {
        ...
        $scope.saveRowIndexing = function () {
            parentGridService.saveRowIndexing($scope);
        };
        ...
        $scope.gridOptions = parentGridService.getUserTaskGridOptions($scope);
        loadUserTasksGrid();
